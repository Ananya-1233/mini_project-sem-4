		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text"  Nameautocomplete="off" />
			    </div>
			  </div> <!--/form-group-->
			  <div class="form-group">
			  ...
			  <div class="form-group submitButtonFooter">
			    ...
			    <button type="button" class="btn btn-default" onclick="addRow()" id="addRowBtn" data-loading-text="Loading..."> Add Row </button>

			      <button type="submit" id="createOrderBtn" data-loading-text="Loading..." class="btn btn-success">Save Changes</button>

			      <button type="reset" class="btn btn-default" onclick="resetOrderForm()">Reset</button>
			    </div>
			  </div>
			</form>
		<?php } else if($_GET['o'] == 'manord') { 
